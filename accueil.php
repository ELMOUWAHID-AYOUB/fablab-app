    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="compte.php">Créer Compte</a>
          </li>
          <li class="nav-item">
  ...
  <main>
    <section class="jumbotron text-center">
      <div class="container">
        ...
        <p class="lead"> </p>
        <a href="aproprs.php" class="btn btn-primary my-2">En Savoir Plus</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          ...
          <a href="page.php" class="btn btn-success">Connecter</a>
        </div>
        <div class="col-md-4">
          <h2>Créer Compte</h2>
         
          <a href="compte.php" class="btn btn-primary">Ajouter</a>
        </div>
        <div class="col-md-4">
          <h2>Récupérer Compte</h2>
         
          <a href="test.php" class="btn btn-warning">Récupérer</a>
        </div>
</div>
</div>
  </main>
