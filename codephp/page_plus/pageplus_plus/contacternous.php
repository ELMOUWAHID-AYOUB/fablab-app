...
<head>
    ...
    <link href="../../../sanscode/bootstrap-5.3.0-alpha3-dist\css\bootstrap.min.css" rel="stylesheet">
...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $mail->Body    = "message:" . "Votre message a été correctement envoyé. Nous sommes maintenant en attente de la réponse du responsable.";
        ...
        if (!$mail->send()) {
         ...
         // Configurer les informations de l'expéditeur et du destinataire
         $mail->setFrom('appweb2023ensaj@gmail.com', 'inventaire appweb');
         $mail->addAddress("appweb2023ensaj@gmail.com");     //Add a recipient
         $mail->isHTML(true);                                  //Set email format to HTML
         $mail->Subject = $subject;
         // $mail->Body    = "message:" . $message;
         $mail->Body    = "message:" .$message;
