...
<body>
	...
	<form action="process.php" method="POST">
		...
		<div class="form-group">
          ...
          <option value="Parfeau">
          <option value="pc">
          <option value="Serveur">
		  <option value="Voip">
		  <option value="Interface_ISDN">
		  <option value="Interface_Ethenet">
		  <option value="Interface_serial">
		  <option value="Serveur">
             </datalist>
		</div>
		<div class="form-group">
	...
	<table class="table">
        ...
        <?php 
        if (true) {
            $result = $mysqli->query("SELECT * FROM equi ") or die($mysqli->error);
