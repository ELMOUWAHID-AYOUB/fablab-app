    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="indexp8.php">Connectiques</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index9.php">Tous</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="demande.php" style="BODY TEXT=#ff0000">Demande</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="accueil.php">Se Deconnecter</a>
          </li>
        </ul>
      </div>
    </nav>
