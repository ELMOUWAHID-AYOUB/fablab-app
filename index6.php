...
<?php include_once('navsite.php'); ?>
	...
	<?php endif ?>
	<h2 class="text text-success">Ajouter un VoIP à l'inventaire</h2>
	...
	<h2>Liste VoIP de l'inventaire</h2>
	<table class="table">
		<thead>
			<tr>
				<th>Nom</th>
        ...
        if (true) {
            ...
            if ($result->num_rows) {
                while ($row = $result->fetch_assoc()) {
					...
					echo "<td>".$row['etat']."</td>";
                    echo "<td>
                            <a href='index6.php?edit=".$row['id']."' class='btn btn-info'>Modifier</a>
